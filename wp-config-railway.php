<?php
/**
 * WordPress Configuration for Railway + Neon
 * Optimized for Railway deployment
 */

// Enable WordPress cache for better performance
 ...
 * These should be stored as environment variables in Railway for security.
 */
...
define( 'WP_HOME', $_ENV['WP_HOME'] ?? getenv('WP_HOME') ?? $_ENV['RAILWAY_STATIC_URL'] ?? 'https://your-railway-domain.railway.app' );
define( 'WP_SITEURL', $_ENV['WP_SITEURL'] ?? getenv('WP_SITEURL') ?? $_ENV['RAILWAY_STATIC_URL'] ?? 'https://your-railway-domain.railway.app' );
...
// Enable WordPress cron for Railway (Railway supports long-running processes)
